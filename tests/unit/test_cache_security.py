...
class TestSymlinkProtection:
    ...
    def test_detect_unsafe_symlinks(self, tmp_path):
        ...
        with patch('rxiv_maker.utils.secure_cache_utils.get_secure_cache_dir', return_value=cache_dir):
            ...
            unsafe_links = [l for l in results["symlinks_found"] if not l["safe"]]
...
class TestDiskSpaceProtection:
    ...
    def test_reject_large_files(self, tmp_path):
        ...
        # Create a file that appears large (mock the stat)
        ...
        with patch.object(Path, 'stat') as mock_stat:
            ...
            assert not secure_migrate_cache_file(source_file, dest_file)
...
class TestPermissionValidation:
    ...
    def test_detect_insecure_permissions(self, tmp_path):
        ...
        cache_dir = tmp_path / "cache"
        cache_dir.mkdir(mode=0o777)  # World writable
