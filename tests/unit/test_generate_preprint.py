...
class TestGeneratePreprintCore(unittest.TestCase):
    ...
    def test_generate_preprint_basic_workflow(
        ...
        mock_write_output.assert_called_once_with(self.output_dir, "processed template content")
...
class TestGeneratePreprintIntegration(unittest.TestCase):
    ...
    def test_full_workflow_integration(
        ...
        mock_write_output.assert_called_once_with(self.output_dir, "\\documentclass{article}\\begin{document}...")
