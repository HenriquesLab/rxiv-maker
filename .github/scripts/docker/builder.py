...
class DockerBuilder:
    ...
    def detect_changes(self) -> bool:
        ...
        try:
            ...
            docker_paths = ["src/docker/", "src/py/", "pyproject.toml", "requirements.txt", "requirements-dev.txt"]
    ...
    def extract_metadata(self) -> Dict[str, Any]:
        ...
        try:
            metadata = {"image_name": self.image_name, "tags": [], "labels": {}}
            ...
            if os.getenv("GITHUB_REF_TYPE") == "tag":
                ...
                if version:
                    metadata["tags"].extend([f"{self.image_name}:{version}", f"{self.image_name}:latest"])
        ...
        try:
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                build_cmd = [
                    ...
                    "--output",
                    f"type=docker,dest={output_file}",
                    self.context_path,
                ]
                ...
                build_cmd.extend(
                    [
                        ...
                        "--cache-to",
                        f"type=gha,scope={cache_scope},mode=max",
                    ]
                )
                ...
                if output_file.exists():
                    ...
                    # Store artifact info
                    self.build_artifacts[platform] = {"file": str(output_file), "size_mb": size_mb}
...
def main():
    ...
    parser.add_argument(
        "--platforms", default="linux/amd64,linux/arm64", help="Comma-separated list of platforms to build for"
    )
    ...
    parser.add_argument("--image-name", default="henriqueslab/rxiv-maker-base", help="Docker image name")
    ...
    builder = DockerBuilder(
        platforms=platforms, push=args.push, debug=args.debug, registry=args.registry, image_name=args.image_name
    )
